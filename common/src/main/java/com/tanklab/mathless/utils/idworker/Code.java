...
import com.tanklab.mathless.utils.idworker.strategy.DefaultRandomCodeStrategy;
...
public class Code {
    ...
    /**
     * Next Unique code. The max length will be 1024-Integer.MAX-Integer.MAX(2147483647) which has
     * 4+10+10+2*1=26 characters. The min length will be 0-0.
     *
