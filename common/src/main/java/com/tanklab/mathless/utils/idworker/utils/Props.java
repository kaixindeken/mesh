package com.tanklab.mathless.utils.idworker.utils;
...
import static com.tanklab.mathless.utils.idworker.utils.Serializes.closeQuietly;
...
public class Props {
    ...
    public static InputStream tryResource(
            String propertiesFileName, String userHomeBasePath, Silent silent) {
