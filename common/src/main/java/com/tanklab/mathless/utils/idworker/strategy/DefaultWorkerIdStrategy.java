package com.tanklab.mathless.utils.idworker.strategy;

import com.tanklab.mathless.utils.idworker.WorkerIdStrategy;
import com.tanklab.mathless.utils.idworker.utils.HttpReq;
import com.tanklab.mathless.utils.idworker.utils.Ip;
import com.tanklab.mathless.utils.idworker.utils.Props;
import com.tanklab.mathless.utils.idworker.utils.Utils;
...
public class DefaultWorkerIdStrategy implements WorkerIdStrategy {
    ...
    private long increaseWithWorkerIdServer() {
        String incId =
                HttpReq.get(idWorkerServerUrl).req("/inc").param("ipu", ipDotUsername).exec();
